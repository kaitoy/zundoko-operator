...
func TestReconcile(t *testing.T) {
	...
	instance := &zundokokiyoshiv1beta1.Hikawa{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Hikawa object and expect the Reconcile and Deployment to be created
